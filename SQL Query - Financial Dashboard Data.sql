...
COPY cc_detail
FROM 'C:\Users\pande\OneDrive\Credit_Card_Dashboard_PowerBI_Project\cc_add.csv' 
DELIMITER ',' 
CSV HEADER;
...
COPY cust_detail
FROM 'C:\Users\pande\OneDrive\Credit_Card_Dashboard_PowerBI_Project\cust_add.csv' 
DELIMITER ',' 
CSV HEADER;
